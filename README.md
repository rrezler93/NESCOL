...
IMPORTANT: In the repository, only those projects were added for which the implementation was open-booked and required creating a custom program/script to solve a specific problem - thus, each project varied depending on the student. Consequently, many topics covered during the learning process were not included here (e.g. whole SQL and Data Structures Units) to protect NESCOL's data and avoid sharing answers to closed-book assessments.
